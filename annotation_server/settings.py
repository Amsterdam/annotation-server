"""
Django settings for annotation_server project.
...
WSGI_APPLICATION = 'annotation_server.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DATABASE_NAME', 'annotation-server'),
        'USER': os.getenv('DATABASE_USER', 'annotation-server'),
